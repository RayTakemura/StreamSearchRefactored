...
const Profile = () => {
  ...
  // create function that accepts the stream's mongo _id value as param and deletes the stream from the database
  const handleDeleteStream = async (streamId) => {
    ...
    try {
      ...
      // upon success, remove stream's id from localStorage
